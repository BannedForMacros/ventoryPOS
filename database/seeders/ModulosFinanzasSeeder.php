...
class ModulosFinanzasSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $hijos = [
            ...
            // orden 0: primero del grupo. El menú ordena SOLO por `orden` (sin
            // desempate), así que repetir el 1 de Balance dejaría el orden al azar.
            ['slug' => 'finanzas.estado-cuenta',     'nombre' => 'Estado de cuenta',     'icono' => 'Users',          'ruta' => '/finanzas/estado-cuenta',      'orden' => 0],
