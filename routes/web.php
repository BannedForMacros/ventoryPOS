...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    */
    ...
    Route::prefix('finanzas')->name('finanzas.')->group(function () {
        ...
        Route::middleware('permiso:finanzas.balance,editar')->post('balance/{fecha}/arqueo', [BalanceDiarioController::class, 'guardarArqueo'])->name('balance.arqueo');
        Route::middleware('permiso:finanzas.balance,editar')->post('balance/{fecha}/arqueo/ajustar', [BalanceDiarioController::class, 'generarAjustesArqueo'])->name('balance.arqueo.ajustar');
    ...
    Route::prefix('reportes')->name('reportes.')->group(function () {
        ...
        Route::middleware('permiso:reportes.cierre-mes,ver')->get('cierre-mes/imprimir', [\App\Http\Controllers\Reportes\ReporteCierreMesController::class, 'imprimir'])->name('cierre-mes.imprimir');
        ...
        Route::middleware('permiso:reportes.agenda,ver')->get('agenda',           [\App\Http\Controllers\Reportes\ReporteAgendaController::class, 'index'])->name('agenda');
