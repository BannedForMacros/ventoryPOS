...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('reportes')->name('reportes.')->group(function () {
        ...
        Route::middleware('permiso:reportes.cierre-mes,ver')->get('cierre-mes/pdf', [\App\Http\Controllers\Reportes\ReporteCierreMesController::class, 'pdf'])->name('cierre-mes.pdf');
